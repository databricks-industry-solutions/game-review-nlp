        ...
        "tasks": [
            ...
            },
            {
                ...
                "libraries": [
                    {
                        "maven": {
                            "coordinates": "com.johnsnowlabs.nlp:spark-nlp_2.12:5.2.3"
                        }
                    }
                ],
                "depends_on": [
            ...
            },
            {
                "job_cluster_key": "game_review_cluster",
                "notebook_task": {
                    "notebook_path": f"03_Post Processing and Dashboard"
                },
                "task_key": "game_review_03",
                "depends_on": [
                    {
                        "task_key": "game_review_02"
                    }
