...
review_texts = spark.sql("""select recommendationid, timestamp_created, review from steam_appreviews_bronze where appid = '1063730' and len(review) > 500""")
...
db_persist_path_chroma = f"{cloud_storage_path}langchain/spacy/chroma/db" 
